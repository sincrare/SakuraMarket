...
ActiveRecord::Schema.define(version: 20170718130851) do
  ...
  create_table "ordered_items", force: :cascade do |t|
    ...
    t.index ["order_history_id"], name: "index_ordered_items_on_order_history_id"
  end
  ...
  create_table "stocked_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id"], name: "index_stocked_items_on_item_id"
    t.index ["user_id"], name: "index_stocked_items_on_user_id"
  end
  ...
  add_foreign_key "stocked_items", "items"
  add_foreign_key "stocked_items", "users"
end
